...
export default {
    ...
    methods: {
        ...
        getConsommablesByDep() {
            axios.get('/ajax/produit/consommables/departement/'+this.userdep).then((response) => {
                const {
                    products
                } = response.data
                this.produits = products
        ...
        addit() {
            axios.post('/ajax/restauration/departement/check', {produit:this.choice, quantite:this.quantite, departement:this.selected}).then((response) => {
                  ...
                  if(response.data.state){
                      this.$root.$emit('add', this.produit, this.quantite, this.prix, this.selected, this.table)
                  }else {
