...
<div class="invoice p-3 mb-3">
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <p class="text-muted well well-sm shadow-none" style="margin-top: 10px;">
                ...
                @else
                <center>
                    <h3><span class="badge badge-pill badge-danger">IMPAYER</span></h3>
                </center>
                @endif
            </p>
        </div>
    ...
    <div class="row no-print">
        <div class="col-12">
            <a href="{{route('facture_print',$facture)}}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
            @if ($etat === 'libéré' or $etat === 'libérer' or $etat === 'facturer')
