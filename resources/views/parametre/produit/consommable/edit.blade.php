...
<div class="col-md-10">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Modifier consommable</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" method="post" action="{{route('consommable_update',$produit)}}" enctype="multipart/form-data">
            <div class="card-body">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input value="{{$produit->achat}}" name="achat" class="form-control" id="achat">
                </div>
