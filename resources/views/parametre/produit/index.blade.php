      ...
      <div class="card">
         ...
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-md-2">
                  <a style="width:100%" href="{{ route('produit_add') }}" class="btn btn-outline-primary"><i
                     ...
                     <tr>
                        ...
                        <td>
                           @if (empty($produit->image))
                              {{ 'VIDE' }}
                           @else
                              <img src="{{ asset('images') . '/' . $produit->image }}" width="60px" height="50px"
                                 alt="{{ $produit->image }}">
                           @endif
                        </td>
                        <td>
                           <a href="{{ route('produit_edit', $produit) }}" class="btn btn-outline-success"><i
                                 class="fas fa-edit"></i> modifier</a>
                           <a href="{{ route('produit_delete', $produit) }}" class="btn btn-outline-danger"><i
