    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-2">
            <a style="width:100%" href="{{route('consommable_index')}}" class="btn btn-outline-primary"><i class="fas fa-shopping-bag"></i> Consommables</a>
          </div>
          <div class="col-md-2">
            ...
            @foreach ($familles as $key => $famille)
              <tr>
                ...
                <td>
                  ...
                  <a href="{{route('famille_delete',$famille)}}" class="btn btn-outline-danger"><i class="fas fa-trash"></i> supprimer</a>
                  <a href="{{route('famille_show',$famille)}}" class="btn btn-outline-warning"><i class="fas fa-eye"></i> voir</a>
                </td>
              </tr>
            @endforeach
          </tbody>
