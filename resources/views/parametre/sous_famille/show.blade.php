    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-2">
           <a style="width:100%" href="{{route('produit_associer',$sous_famille)}}" class="btn btn-outline-primary"><i class="fas fa-plus"></i> ajouter</a>
          </div>
        </div>
        <p class="card-text">
          ...
          <tbody>
            @foreach ($sous_famille->produits as $key => $produit)
              <tr>
                <td>{{$key+1}}</td>
