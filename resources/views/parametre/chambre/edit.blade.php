...
<div class="col-md-10">
    ...
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" method="post" action="{{route('chambre_update',$chambre)}}">
            <div class="card-body">
              @csrf
                <div class="form-group">
                    <label for="exampleInputEmail1">Libelle:</label>
                    <input value="{{$chambre->libelle}}" name="libelle" class="form-control" id="exampleInputEmail1">
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="select2-purple">
                      <select name="batiment" class="form-control" >
                        <option selected value="{{$chambre->batimentLinked->id}}">{{$chambre->batimentLinked->libelle}}</option>
                  ...
                  <div class="form-group">
                    ...
                    <div class="select2-purple">
                      <select name="type" class="form-control">
                        <option selected value="{{$chambre->typeLinked->id}}">{{$chambre->typeLinked->libelle}}</option>
